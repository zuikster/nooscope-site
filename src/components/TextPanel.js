    ...
    <div className={styles.panel}>
      <div className={styles.copy}>
        <p>
          ...
          project and historical investigation into Yurenev&rsquo;s grandfather&rsquo;s unspoken
          experience during World War II.
        </p>
        <p>
          Rooted in the documentary tradition, Yurenev&rsquo;s practice confronts the challenge
          ...
          could not be observed firsthand, one of generative AI&rsquo;s more provocative
        ...
        <p>
          At the heart of the book is a dialogue with Ernst Friedrich&rsquo;s 1924 anti-war
          manifesto <em>War Against War!</em>, which used graphic photographs to dismantle
          war&rsquo;s heroic image. Yurenev responds by employing a bespoke generative model
          trained on 35.000 portraits and landscapes of the WWII-era. The resulting
          synthetic images bear a striking resemblance to Friedrich&rsquo;s photographs, echoing
          ...
          beneath it&mdash;the flesh under the skin of the image.
        </p>
        <p>
          ...
          York. These veterans, of the same generation as Yurenev&rsquo;s grandfather are known
          ...
          psychological: revealing war&rsquo;s true face as grotesque.
        </p>
        <p>
          The object is born out of an amalgam of a dissection of an eighties pocket
          edition of <em>War against War</em>, Yurenev&rsquo;s polymer prints and the response of
